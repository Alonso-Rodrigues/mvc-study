    ...
    <main>
        <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 ">
            <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
                ...
                <p class="lead">Example of a website where I study the Model-View-Controller (MVC) and Object-Oriented Programming (OOP) architecture. Through a series of engaging tutorials and practical examples.</p>
